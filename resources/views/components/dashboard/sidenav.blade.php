<aside class="min-h-screen col-span-1 px-8 bg-white shadow">
    <div class="py-6 space-y-7">
        ...
        <div>
            ...
            <div>
                <x-sidenav.link href="{{ route('admin.threads.owned') }}" :active="request()->routeIs('admin.threads.owned')">
                    <x-zondicon-view-tile class="w-3 text-green-400" />
                    <span>{{ __('My threads') }}</span>
                </x-sidenav.link>
            </div>
            {{-- <div>
                <x-sidenav.link href="{{ route('admin.replies.owned') }}" :active="request()->routeIs('admin.replies.owned')">
                    <x-zondicon-view-tile class="w-3 text-green-400" />
                    <span>{{ __('My replies') }}</span>
                </x-sidenav.link>
            </div> --}}
        </div>
