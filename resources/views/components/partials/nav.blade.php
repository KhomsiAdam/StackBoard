<nav x-data="{ open: false }" class="bg-white shadow">
    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16 space-x-12">
            ...
            {{-- Search Topic --}}
            <div class="flex items-center flex-grow ml-0">

                <div class="p-2 text-white bg-green-600 border rounded-l">
                    <x-heroicon-o-search class="w-6 h-6" />
                </div>
                <input type="search" name="" id="" class="w-full border-none rounded-r shadow-inner bg-green-50 focus:ring-green-200" placeholder="Search Threads">
            </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                <div class="mr-10">
                    ...
                    <a href="{{ route('threads.create') }}" class="inline-flex items-center px-4 py-2 text-xs font-semibold tracking-widest text-white uppercase transition bg-green-500 border border-transparent rounded hover:bg-green-400 active:bg-green-600 focus:outline-none focus:border-green-900 focus:ring focus:ring-green-300 disabled:opacity-25">
                ...
                @else
                <div class="space-x-4">
                    <x-jet-nav-link class="text-white" href="{{ route('login') }}" :active="request()->routeIs('login')">
                        {{ __('Login') }}
                    </x-jet-nav-link>
